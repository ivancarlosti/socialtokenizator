...
return [
    ...
    'settings_favicon_help'         => 'PNG, JPG, WEBP, GIF, ICO o SVG — máx 512 KB. Las cargas rasterizadas se redimensionan a 32x32, 180x180 (apple-touch-icon), 192x192 y 512x512; los SVG se conservan tal cual.',
    'settings_favicon_remove'       => 'Eliminar favicon actual',
    'settings_twitter_site'         => 'Cuenta X/Twitter del sitio',
    'settings_twitter_site_help'    => '@username del sitio usado en la meta etiqueta twitter:site.',
    'settings_default_locale'       => 'Idioma predeterminado',
    'settings_default_theme'        => 'Tema predeterminado',
    'theme_dark'                    => 'Oscuro',
    'theme_light'                   => 'Claro',
    'settings_theme_color_light'    => 'Color del tema (claro)',
    'settings_theme_color_light_help' => 'Color de la barra del navegador en móviles cuando el tema claro está activo.',
    'settings_theme_color_dark'     => 'Color del tema (oscuro)',
    'settings_theme_color_dark_help' => 'Color de la barra del navegador en móviles cuando el tema oscuro está activo.',
    ...
    'settings_short_id_length'     => 'Longitud del ID corto del post',
    'settings_short_id_length_help'=> 'Número de caracteres en el ID corto de la URL del post (3–32, predeterminado: 6). Los posts existentes conservan sus IDs actuales.',
    ...
    'settings_api_token_no_user'    => 'Ninguna cuenta de usuario está asociada a esta sesión. Cierra sesión y vuelve a entrar para gestionar tu token de API.',
    ...
    'settings_post_meta_single' => 'Página de publicación única',
    'settings_post_meta_list' => 'Páginas con muchas publicaciones (portada y búsqueda)',
    'settings_show_post_author' => 'Mostrar autor en las publicaciones',
    'settings_show_post_author_help' => 'Muestra el autor de la publicación (nombre visible o correo) en la página de publicación única.',
    'settings_show_post_published' => 'Mostrar fecha/hora de publicación',
    'settings_show_post_published_help' => 'Muestra la fecha/hora de publicación en la página de publicación única.',
    'settings_show_post_updated' => 'Mostrar fecha/hora de actualización',
    'settings_show_post_updated_help' => 'Muestra la fecha/hora de actualización en la página de publicación única en publicaciones modificadas.',
    'settings_show_post_author_in_list' => 'Mostrar autor en las publicaciones',
    'settings_show_post_author_in_list_help' => 'Muestra el autor de la publicación (nombre visible o correo) en las páginas con muchas publicaciones (portada y búsqueda).',
    'settings_show_post_published_in_list' => 'Mostrar fecha/hora de publicación',
    'settings_show_post_published_in_list_help' => 'Muestra la fecha/hora de publicación en las páginas con muchas publicaciones (portada y búsqueda).',
    'settings_show_post_updated_in_list' => 'Mostrar fecha/hora de actualización',
    'settings_show_post_updated_in_list_help' => 'Muestra la fecha/hora de actualización en las páginas con muchas publicaciones (portada y búsqueda) en publicaciones modificadas.',

    // Site timezone
    'settings_site_timezone' => 'Zona horaria del sitio',
    'settings_site_timezone_help' => 'Zona horaria usada para mostrar fechas y horas en el sitio. Los feeds y las marcas de tiempo legibles por máquina permanecen en UTC.',
    'settings_site_timezone_invalid' => 'Selecciona una zona horaria válida.',

    // Post description on list pages
    'settings_show_post_description_in_list' => 'Mostrar descripción en las páginas de lista',
    'settings_show_post_description_in_list_help' => 'Muestra la descripción de la publicación en la portada y en los resultados de búsqueda.',
    'settings_post_description_mode' => 'Tamaño de la descripción',
    'settings_post_description_mode_excerpt' => 'Resumen',
    'settings_post_description_mode_full' => 'Texto completo',
    'settings_post_description_length' => 'Límite de caracteres del resumen',
    'settings_post_description_length_help' => 'Máximo de caracteres mostrados en el modo resumen (1–2000).',

    // Post description on feeds
    'settings_show_post_description_in_feed' => 'Mostrar descripción en los feeds',
    'settings_show_post_description_in_feed_help' => 'Incluye la descripción de la publicación en los feeds Atom, RSS y JSON.',

    // Users tab
    'settings_tab_users' => 'Usuarios',
    'settings_users_heading' => 'Usuarios (autores)',
    'settings_users_help' => 'Gestiona los usuarios autorizados a iniciar sesión. El nombre visible se muestra como autor; cuando está vacío, se muestra el correo. El enlace opcional abre el nombre del autor en una ventana nueva.',
    'settings_users_link' => 'Enlace (opcional)',
