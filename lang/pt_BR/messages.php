...
return [
    ...
    'settings_favicon_help'         => 'PNG, JPG, WEBP, GIF, ICO ou SVG — máx 512 KB. Uploads rasterizados são redimensionados para 32x32, 180x180 (apple-touch-icon), 192x192 e 512x512; SVGs são mantidos como estão.',
    'settings_favicon_remove'       => 'Remover favicon atual',
    'settings_twitter_site'         => 'Conta X/Twitter do site',
    'settings_twitter_site_help'    => '@username do site usado na meta tag twitter:site.',
    'settings_default_locale'       => 'Idioma padrão',
    'settings_default_theme'        => 'Tema padrão',
    'theme_dark'                    => 'Escuro',
    'theme_light'                   => 'Claro',
    'settings_theme_color_light'    => 'Cor do tema (claro)',
    'settings_theme_color_light_help' => 'Cor da barra do navegador em dispositivos móveis quando o tema claro está ativo.',
    'settings_theme_color_dark'     => 'Cor do tema (escuro)',
    'settings_theme_color_dark_help' => 'Cor da barra do navegador em dispositivos móveis quando o tema escuro está ativo.',
